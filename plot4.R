...
plot(x=days2_in_feb$DateTime,y=days2_in_feb$Global_active_power,type="l",ylab="Global Active Power", xlab="")

plot(x=days2_in_feb$DateTime,y=days2_in_feb$Voltage,type="l", xlab="datetime", ylab="Voltage")
...
plot(x=days2_in_feb$DateTime,y=days2_in_feb$Global_reactive_power,type="l", xlab="datetime", ylab="Global_reactive_power")
